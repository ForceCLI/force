...
func (o *OLS) addProperty(name string, value string) {
	switch name {
		case "object": o.objectName = value
		case "allowCreate": o.allowCreate = value
		case "allowDelete": o.allowDelete = value
		case "allowEdit": o.allowEdit = value
		case "allowRead": o.allowRead = value
		case "modifyAllRecords": o.modifyAllRecords = value
		case "viewAllRecords": o.viewAllRecords = value
	}
...
func (o *OLS) getProperty(name string) string {
	switch name {
		case "Allow Create": return o.allowCreate
		case "Allow Delete": return o.allowDelete
		case "Allow Edit": return o.allowEdit
		case "Allow Read": return o.allowRead
		case "Modify All Records": return o.modifyAllRecords
		case "View All Records": return o.viewAllRecords
	}
	return ""
}
...
func (f *FLS) addProperty(name string, value string) {
	switch name {
		case "field": f.field = value
		case "editable": f.editable = value
		case "readable": f.readable = value
	}
